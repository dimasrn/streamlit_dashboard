        ...
        if selected_table:
            try:
                ...
                if selected_date_col:
                    ...
                    start_date = st.sidebar.date_input("Dari Tanggal", min_value=min_date, max_value=max_date)
                    end_date = st.sidebar.date_input("Sampai Tanggal", min_value=start_date, max_value=max_date)
